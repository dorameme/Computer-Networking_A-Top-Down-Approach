...
- 와이파이는 무선 통신 기술을 사용해 인터넷이나 네트워크에 연결할 수 있는 기술로, 
- 전통적인 유선 LAN의 무선 버전이라고 볼 수 있습니다. 이를 통해 집이나 사무실, 
- 공공장소에서 물리적인 케이블 없이 인터넷을 사용할 수 있게 되며 Wi-Fi는 주로 IEEE 표준을 기반으로 한다.
