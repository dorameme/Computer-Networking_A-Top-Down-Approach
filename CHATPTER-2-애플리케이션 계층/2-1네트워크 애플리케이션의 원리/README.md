...
### P2P구조
- 항상켜져있는 서버에 최소로 의존한다.
- 피어라는 간헐적으로 연겨로딘 호스트 쌍들이 직접 소통한다.
...
### 클라이언트와 서버 프로세스
- 웹애서 브라우저는 클라이언트프로세스, 웹서버는 서버프로세스.
...
- 웹 브라우저는 웹 서버 프로세스와 접속을 초기화 하므로 클라이언트,
  웹서버 프로세스는 서버이다.
...
- 처리율요구서헝을 가지는 애플리케이션을 '대역폭 민감 애플리케이션'이라고 한다.
